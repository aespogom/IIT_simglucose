...
from models.student import RNN_parallel as student
...
def prepare_trainer(args):
    ...
    student_model = student.RNN_parallel()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dump_path",
        type=str,
        default=os.path.join("results","RNN_parallel"),
    ...
    run_name = f"s_RNN_parallel_t_simglucose_data_insilico_seed_56_{args.date_experiment}_PH_{str(args.pred_horizon)}" if args.neuro_mapping else f"s_RNN_parallel_data_insilico_seed_56_{args.date_experiment}_PH_{str(args.pred_horizon)}"
