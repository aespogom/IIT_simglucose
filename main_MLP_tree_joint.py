...
from models.student import MLP_tree_joint as student
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--neuro_mapping",
        type=str,
        # default="train_config/MLP_tree_joint.nm",
        default=None,
    ...
    run_name = f"s_MLP_tree_joint_t_simglucose_data_insilico_seed_56_{today}_PH_{str(args.pred_horizon)}" if args.neuro_mapping else f"s_MLP_tree_joint_data_insilico_seed_56_{today}_PH_{str(args.pred_horizon)}"
