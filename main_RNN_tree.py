...
from models.student import RNN_tree as student
...
def prepare_trainer(args):
    ...
    student_model = student.RNN_tree()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dump_path",
        type=str,
        default=os.path.join("results","RNN_tree"),
        help="The output directory (log, checkpoints, parameters, etc.)"
    )
    parser.add_argument(
        "--neuro_mapping",
        type=str,
        # default="train_config/RNN_tree.nm",
        # default=None,
    ...
    run_name = f"s_RNN_tree_t_simglucose_data_insilico_seed_56_{args.date_experiment}_PH_{str(args.pred_horizon)}" if args.neuro_mapping else f"s_RNN_tree_data_insilico_seed_56_{args.date_experiment}_PH_{str(args.pred_horizon)}"
