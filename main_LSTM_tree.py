...
from models.student import LSTM_tree as student
...
def prepare_trainer(args):
    ...
    student_model = student.LSTM_tree()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dump_path",
        type=str,
        default=os.path.join("results","LSTM_tree"),
    ...
    run_name = f"s_LSTM_tree_t_simglucose_data_insilico_seed_56_{args.date_experiment}_PH_{str(args.pred_horizon)}" if args.neuro_mapping else f"s_LSTM_tree_data_insilico_seed_56_{args.date_experiment}_PH_{str(args.pred_horizon)}"
