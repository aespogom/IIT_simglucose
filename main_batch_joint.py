...
tasks = [
    ...
    ['main_MLP_tree_joint.py', '--pred_horizon','120', '--neuro_mapping','train_config/MLP_tree_joint_remove_cyclic.nm', "--dump_path","results/MLP_joint/remove_cyclic"], # Added missing comma here
