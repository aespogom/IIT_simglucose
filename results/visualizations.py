...
train_type = input("Which training (causal, regular) :")
assert train_type in ["causal", "regular"]
...
if train_type == "causal":
    ...
    train_loss = load(open(os.path.join('results',parent_folder,f's_{parent_folder}_data_insilico_seed_56_{date_exp}_PH_{pred_h}','train_loss.pkl'), 'rb'))
