...
class LSTM_tree(nn.Module):
    def __init__(self, n_in=20, n_out=1, n_hidden=256, n_neurons=1, dropout=0.3):
        ...
        # X_1
        self.X_1 = nn.LSTM(self.n_in,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        # X_10
        self.X_10 = nn.LSTM(self.n_in,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        # X_11
        self.X_11 = nn.LSTM(self.n_in,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        # X_12
        self.X_12 = nn.LSTM(self.n_in,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        # X_5
        self.X_5 = nn.LSTM(self.n_in,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        # X_2
        self.X_2 = nn.LSTM(self.n_hidden,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        # X_3
        self.X_3 = nn.LSTM(self.n_hidden,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        ...
        # X_6
        self.X_6 = nn.LSTM(3*self.n_hidden,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        # X_4
        self.X_4 = nn.LSTM(3*self.n_hidden,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        ...
        # X_8
        self.X_8 = nn.LSTM(self.n_hidden,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        # X_9
        self.X_9 = nn.LSTM(self.n_hidden,
                            self.n_hidden,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        ...
        # X_13
        self.X_13 = nn.LSTM(self.n_hidden,
                            self.n_out,
                            self.n_neurons,
                            bidirectional=False,
                            batch_first=True)
        
        self.output = nn.Linear(n_out, n_out)
    ...
    def forward(self,
        ...
        x = torch.cat([input_ids[0:10], input_ids[12:]]).unsqueeze(0) # Exclude CHO and insulin without scaling
        hooks = []
        ...
        hooks, student_output, out10 = interchange_intervention(
            x,
            interchanged_variables, 
            variable_names,
            interchanged_activations,
        ...
        hooks, student_output, out5 = interchange_intervention(
            x,
            interchanged_variables, 
            variable_names,
            interchanged_activations,
        ...
        hooks, student_output, out6 = interchange_intervention(
            torch.cat((out10.squeeze(0), out11.squeeze(0), out12.squeeze(0))).unsqueeze(0),
            interchanged_variables, 
            variable_names,
            interchanged_activations,
            5,
        ...
        hooks, student_output, out4 = interchange_intervention(
            torch.cat((out3.squeeze(0), out5.squeeze(0), out9.squeeze(0))).unsqueeze(0),
            interchanged_variables, 
            variable_names,
            interchanged_activations,
            3,
        ...
        student_output["outputs"] = self.output(out13).squeeze(0)
...
def interchange_intervention(x,
    ...
    student_output["hidden_states"][i] = h
