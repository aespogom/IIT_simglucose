...
tasks = [
    ...
    ['python','-m', 'main_MLP_tree', '--pred_horizon','30'],
    ['python','-m', 'main_MLP_tree', '--pred_horizon','45'],
    ['python','-m', 'main_MLP_tree', '--pred_horizon','60'],
    ['python','-m', 'main_MLP_tree', '--pred_horizon','120'],
    # # MLP Tree joint
