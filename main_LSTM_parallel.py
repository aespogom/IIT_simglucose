...
from models.student import LSTM_parallel as student
...
def prepare_trainer(args):
    ...
    student_model = student.LSTM_parallel()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dump_path",
        type=str,
        default=os.path.join("results","LSTM_parallel"),
        help="The output directory (log, checkpoints, parameters, etc.)"
    )
    parser.add_argument(
        "--neuro_mapping",
        type=str,
        # default="train_config/LSTM_parallel.nm",
        # default=None,
    ...
    run_name = f"s_LSTM_parallel_t_simglucose_data_insilico_seed_56_{args.date_experiment}_PH_{str(args.pred_horizon)}" if args.neuro_mapping else f"s_LSMT_v1_data_insilico_seed_56_{args.date_experiment}_PH_{str(args.pred_horizon)}"
